...
namespace AssetStudio
{
    ...
    internal class ImportedSubmesh
    {
    ...
    internal class ImportedFace
    {
        public int[] VertexIndices { get; set; }
    }

    internal class ImportedBone
    {
        public string Path { get; set; }
        public Matrix4x4 Matrix { get; set; }
    }

    internal class ImportedMaterial
    {
        public string Name { get; set; }
    ...
    internal class ImportedMaterialTexture
    {
        public string Name { get; set; }
    ...
    internal class ImportedTexture
    {
        public string Name { get; set; }
    ...
    internal class ImportedKeyframedAnimation
    {
        public string Name { get; set; }
    ...
    internal class ImportedAnimationKeyframedTrack
    {
        public string Path { get; set; }
    ...
    internal class ImportedKeyframe<T>
    {
    ...
    internal class ImportedMorphVertex
    {
        public uint Index { get; set; }
        public ImportedVertex Vertex { get; set; }
    }

    internal static class ImportedHelpers
    {
