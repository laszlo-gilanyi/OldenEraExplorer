...
namespace AssetStudio
{
    ...
    internal enum GfxPrimitiveType
    {
        Triangles = 0,
        TriangleStrip = 1,
        Quads = 2,
    ...
    internal class VGPageStreamingInfo
    {
        public uint offset;
    ...
    internal class SharedClusterData //Tuanjie
    {
    ...
    internal sealed class Mesh : NamedObject
    {
    ...
    {
        internal enum VertexChannelFormat
        {
            Float,
            Float16,
            Color,
        ...
        internal enum VertexFormat2017
        {
            Float,
            Float16,
            Color,
