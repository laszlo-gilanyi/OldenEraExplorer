...
namespace AssetStudio
{
    ...
    internal class StreamedClip
    {
        ...
        internal class StreamedCurveKey
        {
            public int index;
            public float[] coeff;
    ...
    internal class ACLClip //Tuanjie
    {
    ...
    internal class ClipMuscleConstant
    {
    ...
    internal sealed class AnimationClip : NamedObject
    {
        ...
        internal class EqComparer : IEqualityComparer<AnimationClip>
        {
